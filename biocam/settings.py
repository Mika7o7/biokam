"""
Django settings for biocam project.
...
WSGI_APPLICATION = 'biocam.wsgi.application'
...
# Настройки сессий (можно добавить для отладки)
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = False  # Не удалять при закрытии браузера